...
describe("CarService Suite Tests", () => {
  ...
  it("should retrives ramdom position from an array", () => {
  ...
  it('given a customer an da car category it should return a transaction receipt', async () => {
    const car = mocks.validCar
    const carCategory = {
